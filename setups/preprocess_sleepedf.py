...
def main():
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default="/opt/pytorch/Datasets/physionet.org/files/sleep-edfx/1.0.0/sleep-cassette",
        help="File path to the CSV or NPY file that contains walking data.",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/opt/pytorch/Datasets/physionet_sleep",
...
def make_db(task: str):
    # Define DB
    BASE_PATH = "/opt/pytorch/Datasets/physionet_sleep"
    DB_PATH = "/opt/pytorch/DFformer/databases"
    file_idx = 0
    EPOCH_LENGTH = 30
    SAVE_PATH = "/opt/pytorch/Datasets/physionet_sleep_preprocessed_" + str(
        EPOCH_LENGTH
    )
